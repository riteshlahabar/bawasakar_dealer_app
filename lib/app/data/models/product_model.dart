class ProductModel {
  ...
  static String _categoryName(
    ...
    if (category is Map) {
      return category['storefront_name']
                  ?.toString() ??
              category['name']
                  ?.toString() ??
              '';
  ...
  static String _unitName(
    ...
    return json['unit_name']
                ?.toString() ??
            unit?.toString() ??
            '';
  }

  static double _firstPrice(
    Map<String, dynamic> json,
    List<String> keys,
  ) {
